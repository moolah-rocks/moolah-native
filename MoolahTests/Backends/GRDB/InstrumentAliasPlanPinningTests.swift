...
/// `EXPLAIN QUERY PLAN`-pins the resolver's alias map-build query
/// (`SELECT id, alias_of FROM instrument WHERE alias_of IS NOT NULL`) so any
/// schema edit that drops or renames `instrument_by_alias` fails the build
/// immediately. Per `DATABASE_CODE_GUIDE.md` §6.
